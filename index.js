...
function transposeBar() {
  ...
  svg.select("line").transition().duration(duration).attr("x2", w);
...
$("#radio_2").click(function horizons() {
  svg
    .insert("defs", ".symbol")
    .append("clipPath")
    .attr("id", "clip")
...
$("#radio_4").click(function stackedArea() {
  var stack = d3.layout
    .stack()
    .values(function (d) {
      return d.values;
...
$("#radio_5").click(function streamgraph() {
  var stack = d3.layout
    .stack()
    .values(function (d) {
      return d.values;
  ...
  var t = svg.selectAll(".symbol").transition().duration(duration);
...
$("#radio_6").click(function overlappingArea() {
  var g = svg.selectAll(".symbol");
...
$("#radio_7").click(function overlappingArea() {
  var g = svg.selectAll(".symbol");
